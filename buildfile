...
# Fix the coverage reports generated by Emma.  For some reason they
# add a non-breaking space (U+00A0) but don't HTML encode it.
namespace :emma do
 task :html do
  info "Fixing emma reports"
  Dir['reports/emma/**/*.html'].each do |html_file|
