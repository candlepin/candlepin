...
public class JsRunnerProvider implements Provider<JsRunner> {
    private static final Logger log = LoggerFactory.getLogger(JsRunnerProvider.class);

    private final RulesCurator rulesCurator;
    private final JsRunnerRequestCache cacheProvider;
    ...
    @Inject
    public JsRunnerProvider(RulesCurator rulesCurator, JsRunnerRequestCache cacheProvider) {
    ...
    public JsRunner get() {
         ...
         */
        JsRunnerRequestCache cache = cacheProvider;
