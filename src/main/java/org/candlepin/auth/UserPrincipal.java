...
public class UserPrincipal extends Principal {
    ...
    public UserPrincipal(String username, Collection<? extends Permission> permissions, boolean admin) {
        this(username, permissions, admin, null, null);
    }
    ...
    public UserPrincipal(String username, Collection<? extends Permission> permissions, boolean admin,
                         OwnerInfo primaryOwner, AuthenticationMethod authMethod) {
        this.username = username;
        this.admin = admin;
        this.primaryOwner = primaryOwner;
        this.authMethod = authMethod == null ? AuthenticationMethod.BASIC : authMethod;
    ...
    public UserPrincipal setAuthenticationMethod(AuthenticationMethod method) {
        this.authMethod = method;
        return this;
    }

    public AuthenticationMethod getAuthenticationMethod() {
        return authMethod ==  null ? AuthenticationMethod.BASIC : authMethod;
    }
