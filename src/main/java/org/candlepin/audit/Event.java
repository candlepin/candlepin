...
public class Event {
    ...
    public enum Type {
        ...
        /**
         * Represents a modification event for multiple entities of the given target. Certain event fields
         * such as targetName or entityId should remain unset because this type represents a collection of
         * entities.
         */
        BULK_MODIFICATION,
