...
public class RegenEnvEntitlementCertsJob implements AsyncJob {
    ...
    @Inject
    public RegenEnvEntitlementCertsJob(EntitlementCertificateService entitlementCertificateService) {
    ...
    public void execute(JobExecutionContext context) {
        ...
        this.entitlementCertificateService.regenerateCertificatesOf(environmentId, contentIds, lazy);
