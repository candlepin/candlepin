...
public class RevokeEntitlementsJob implements AsyncJob {
    ...
    public void execute(JobExecutionContext context) throws JobExecutionException {
        ...
        if (owner == null) {
            log.info("Unable to find owner for owner key \"{}\"", ownerKey);
            context.setJobResult("Unable to find owner for owner key \"%s\"", ownerKey);
            return;
        }
        ...
        String msg = "%s completed successfully. %d entitlements revoked and %d activation key pools " +
            "removed.";
    ...
    public static class RevokeEntitlementsJobConfig extends JobConfig<RevokeEntitlementsJobConfig> {
        ...
        /**
         * Sets the owner key for this {@link RevokeEntitlementsJobConfig}.
         *
         * @param ownerKey
         *  the owner key to set
         *
         * @throws IllegalArgumentException
         *  if the owner key is null or blank
         *
         * @return a reference to this RevokeEntitlementsJobConfig
         */
        public RevokeEntitlementsJobConfig setOwnerKey(String ownerKey) {
