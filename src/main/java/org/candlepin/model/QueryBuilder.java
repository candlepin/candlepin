...
public abstract class QueryBuilder<Q extends QueryBuilder, T> {
    ...
    public static enum Inclusion {
        ...
        Inclusion(String apiName) {
            this.apiName = Objects.requireNonNull(apiName);
        }

        /**
         * Returns the API name for this inclusion type
         *
         * @return
         *  the API name for this inclusion type
         */
        ...
        /**
         * Attempts to find a matching inclusion type from the given API name, ignoring case. If the given
         * API name does not map to a known inclusion type, this function returns an empty optional. If
         * no API name is provided, or the provided value is empty, this function returns the provided
         * default value.
         *
         * @param apiName
         *  the API name of the inclusion type to match
         *
         * @param defaultValue
         *  the default value to use if no API name is provided
         *
         * @return
         *  the inclusion type mapped to the given API name, or an empty optional if no matching inclusion
         *  was found
         */
        public static Optional<Inclusion> fromApiName(String apiName, Inclusion defaultValue) {
            if (apiName == null || apiName.isEmpty()) {
                return Optional.ofNullable(defaultValue);
            }

            for (Inclusion inclusion : Inclusion.values()) {
                if (inclusion.apiName.equalsIgnoreCase(apiName)) {
         ...
         * Attempts to find a matching inclusion type from the given API name, ignoring case. If the given
         * API name does not map to a known inclusion type, this function returns an empty optional. If
         * no API name is provided, or the provided value is empty, this function returns an empty optional.
         *
         * @param apiName
         *  the API name of the inclusion type to match
         *
         ...
         *  was found
         */
        public static Optional<Inclusion> fromApiName(String apiName) {
            return Inclusion.fromApiName(apiName, null);
        }
    }
     ...
     */
    public QueryBuilder(Provider<EntityManager> entityManagerProvider) {
