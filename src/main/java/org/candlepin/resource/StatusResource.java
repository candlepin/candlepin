...
//    private KeycloakConfiguration keycloakConfig;
    ...
    public StatusResource(RulesCurator rulesCurator,
        JsRunnerProvider jsProvider,
        CandlepinCache candlepinCache, CandlepinModeManager modeManager,
        @ConfigProperty(name = "candlepin.standalone") boolean isStandalone,
        @ConfigProperty(name = "candlepin.auth.keycloak.enable") boolean keyCloakEnabled) {
