...
public enum ContentAccessMode {
     ...
     *
     * @return a database value to represent this ContentAccessMode instance
     */
     ...
     *
     * @param name the content access mode name to check
     * @return true if the content access mode name matches the name of this ContentAccessMode
     ...
     *
     * @return the default ContentAccessMode instance
     */
     ...
     * @return the ContentAccessMode value representing the given mode name, or null if the provided
     * content access mode name is null
     * @throws IllegalArgumentException if the name cannot be resolved to a valid content access mode
     */
     ...
     *
     * @param name        the name to resolve
     * @param resolveNull whether or not to treat null values as empty values for resolution
     * @return the ContentAccessMode value representing the given mode name, or null if the provided
