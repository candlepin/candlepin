...
public class ProductNodeVisitor implements NodeVisitor<Product, ProductInfo> {
    ...
    private boolean clearedForDeletion(EntityNode<Product, ProductInfo> node) {
        ...
        // TODO: FIXME: Don't ship this. Actually do the orphan cleanup? Maybe? With only one copy
        // of products and content hanging out, we may not need this anymore. Also Hosted doesn't
        // use it at all, and Sat isn't large enough scale for this to matter (again).
        return false;
    }
