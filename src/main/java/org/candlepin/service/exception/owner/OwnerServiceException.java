 ...
 */
package org.candlepin.service.exception.owner;

import org.candlepin.service.exception.ServiceException;


/**
 * The OwnerServiceException is used to as a base for all exceptions returned from
 * the product service adapter.
 */
public class OwnerServiceException extends ServiceException {
    /**
     ...
     */
    public OwnerServiceException(Throwable cause) {
        super(cause);
    }
