...
/**
 * The CouldNotEntitleOrganizationException indicates that the owner could not be entitled upstream
 * of candlepin
 */
public class CouldNotEntitleOrganizationException extends RuntimeException {
     ...
     */
    public CouldNotEntitleOrganizationException() {
        super();
    }
     ...
     *     method.
     */
    public CouldNotEntitleOrganizationException(String message) {
        super(message);
    }
     ...
     */
    public CouldNotEntitleOrganizationException(Throwable cause) {
        super(cause);
    }
     ...
     *     value is permitted, and indicates that the cause is nonexistent or unknown.
     */
    public CouldNotEntitleOrganizationException(String message, Throwable cause) {
        super(message, cause);
    }
}
