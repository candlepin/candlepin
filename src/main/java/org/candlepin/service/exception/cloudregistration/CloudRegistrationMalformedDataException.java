 ...
 */
public class CloudRegistrationMalformedDataException extends CloudRegistrationServiceException {
    /**
     ...
     */
    public CloudRegistrationMalformedDataException() {
        super();
    }
     ...
     *  method.
     */
    public CloudRegistrationMalformedDataException(String message) {
        super(message);
    }
     ...
     */
    public CloudRegistrationMalformedDataException(Throwable cause) {
        super(cause);
    }
     ...
     *  value is permitted, and indicates that the cause is nonexistent or unknown.
     */
    public CloudRegistrationMalformedDataException(String message, Throwable cause) {
        super(message, cause);
    }
}
