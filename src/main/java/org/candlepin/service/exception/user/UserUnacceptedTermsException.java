...
public class UserUnacceptedTermsException extends UserServiceException {
     ...
     */
    public UserUnacceptedTermsException(String username) {
        super();
     ...
     *  method.
     */
    public UserUnacceptedTermsException(String username, String message) {
        super(message);
        this.username = username;
    }
     ...
     */
    public UserUnacceptedTermsException(String username, Throwable cause) {
        super(cause);
        this.username = username;
    }
     ...
     *  value is permitted, and indicates that the cause is nonexistent or unknown.
     */
    public UserUnacceptedTermsException(String username, String message, Throwable cause) {
        super(message, cause);
        this.username = username;
    }
