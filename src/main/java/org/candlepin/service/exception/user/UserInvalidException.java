...
public class UserInvalidException extends UserServiceException {
     ...
     *  method.
     */
    public UserInvalidException(String username, String message) {
        super(message);
        this.username = username;
    }
     ...
     */
    public UserInvalidException(String username, Throwable cause) {
        super(cause);
        this.username = username;
    }
     ...
     *  value is permitted, and indicates that the cause is nonexistent or unknown.
     */
    public UserInvalidException(String username, String message, Throwable cause) {
        super(message, cause);
        this.username = username;
    }
