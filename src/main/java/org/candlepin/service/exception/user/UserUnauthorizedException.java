...
/**
 * The UserUnauthorizedException is used to reject a user validation action.
 */
public class UserUnauthorizedException extends UserServiceException {
     ...
     *  method.
     */
    public UserUnauthorizedException(String username, String message) {
        super(message);
        this.username = username;
    }
     ...
     */
    public UserUnauthorizedException(String username, Throwable cause) {
        super(cause);
        this.username = username;
    }
     ...
     *  value is permitted, and indicates that the cause is nonexistent or unknown.
     */
    public UserUnauthorizedException(String username, String message, Throwable cause) {
        super(message, cause);
        this.username = username;
    }
