 ...
 */
package org.candlepin.service.exception.entitlementcert;

import org.candlepin.service.exception.ServiceException;


/**
 * The EntitlementServiceException is used to as a base for all exceptions returned from
 * the product service adapter.
 */
public class EntitlementCertServiceException extends ServiceException {
    /**
     ...
     */
    public EntitlementCertServiceException() {
        super();
    }
     ...
     *  method.
     */
    public EntitlementCertServiceException(String message) {
        super(message);
    }
     ...
     */
    public EntitlementCertServiceException(Throwable cause) {
        super(cause);
    }
     ...
     *  value is permitted, and indicates that the cause is nonexistent or unknown.
     */
    public EntitlementCertServiceException(String message, Throwable cause) {
        super(message, cause);
    }
}
