 ...
 */
package org.candlepin.service.exception.identitycert;

import org.candlepin.service.exception.ServiceException;


/**
 * The IdentityServiceException is used to as a base for all exceptions returned from
 * the product service adapter.
 */
public class IdentityCertServiceException extends ServiceException {
    /**
     ...
     */
    public IdentityCertServiceException() {
        super();
    }
     ...
     *  method.
     */
    public IdentityCertServiceException(String message) {
        super(message);
    }
     ...
     */
    public IdentityCertServiceException(Throwable cause) {
        super(cause);
    }
     ...
     *  value is permitted, and indicates that the cause is nonexistent or unknown.
     */
    public IdentityCertServiceException(String message, Throwable cause) {
        super(message, cause);
    }
}
