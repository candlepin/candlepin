...
public class SubscriptionExhaustedTagException extends SubscriptionServiceException {
     ...
     */
    public SubscriptionExhaustedTagException() {
        super();
    }
     ...
     *  method.
     */
    public SubscriptionExhaustedTagException(String message) {
        super(message);
    }
     ...
     */
    public SubscriptionExhaustedTagException(Throwable cause) {
        super(cause);
    }
     ...
     *  value is permitted, and indicates that the cause is nonexistent or unknown.
     */
    public SubscriptionExhaustedTagException(String message, Throwable cause) {
        super(message, cause);
    }
}
