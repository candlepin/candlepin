...
/**
 * The SubscriptionExhaustedTagException is used to reject an activation attempt for a
 *  * subscription.
 */
public class SubscriptionExhaustedTagException extends SubscriptionServiceException {
    private final String dellAssetTag;
     ...
     *
     * @param dellAssetTag
     *  the Dell asset tag in the request context. Used in messaging.
     *
     * @param ownerKey
     *  the owner key in the request context. Used in messaging.
     */
    public SubscriptionExhaustedTagException(String dellAssetTag, String ownerKey) {
        super();
        this.dellAssetTag = dellAssetTag;
     ...
     *  method.
     */
    public SubscriptionExhaustedTagException(String dellAssetTag, String ownerKey, String message) {
        super(message);
        this.dellAssetTag = dellAssetTag;
        this.ownerKey = ownerKey;
    }
     ...
     */
    public SubscriptionExhaustedTagException(String dellAssetTag, String ownerKey, Throwable cause) {
        super(cause);
        this.dellAssetTag = dellAssetTag;
        this.ownerKey = ownerKey;
    }
    ...
    public String getDellAssetTag() {
        return this.dellAssetTag;
    }
