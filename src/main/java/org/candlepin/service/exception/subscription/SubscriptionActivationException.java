...
/**
 * The SubscriptionActivationException is used to reject an activation attempt for a
 * subscription.
 */
public class SubscriptionActivationException extends SubscriptionServiceException {
     ...
     */
    public SubscriptionActivationException(String dellAssetTag, String ownerKey) {
        super();
     ...
     *  method.
     */
    public SubscriptionActivationException(String dellAssetTag, String ownerKey, String message) {
        super(message);
        this.dellAssetTag = dellAssetTag;
        this.ownerKey = ownerKey;
    }
     ...
     */
    public SubscriptionActivationException(String dellAssetTag, String ownerKey, Throwable cause) {
        super(cause);
        this.dellAssetTag = dellAssetTag;
        this.ownerKey = ownerKey;
    }
