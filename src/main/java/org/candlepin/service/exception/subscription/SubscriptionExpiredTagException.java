...
public class SubscriptionExpiredTagException extends SubscriptionServiceException {
     ...
     */
    public SubscriptionExpiredTagException(String dellAssetTag, String ownerKey) {
        super();
     ...
     *  method.
     */
    public SubscriptionExpiredTagException(String dellAssetTag, String ownerKey, String message) {
        super(message);
        this.dellAssetTag = dellAssetTag;
        this.ownerKey = ownerKey;
    }
     ...
     */
    public SubscriptionExpiredTagException(String dellAssetTag, String ownerKey, Throwable cause) {
        super(cause);
        this.dellAssetTag = dellAssetTag;
        this.ownerKey = ownerKey;
    }
