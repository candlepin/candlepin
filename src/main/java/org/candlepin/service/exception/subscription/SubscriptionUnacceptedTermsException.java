 ...
 *  * subscription.
 */
public class SubscriptionUnacceptedTermsException extends SubscriptionServiceException {
     ...
     */
    public SubscriptionUnacceptedTermsException(String dellAssetTag, String ownerKey) {
        super();
     ...
     *  method.
     */
    public SubscriptionUnacceptedTermsException(String dellAssetTag, String ownerKey, String message) {
        super(message);
        this.dellAssetTag = dellAssetTag;
        this.ownerKey = ownerKey;
    }
     ...
     */
    public SubscriptionUnacceptedTermsException(String dellAssetTag, String ownerKey, Throwable cause) {
        super(cause);
        this.dellAssetTag = dellAssetTag;
        this.ownerKey = ownerKey;
    }
