...
public class SubscriptionInvalidTagException extends SubscriptionServiceException {
     ...
     */
    public SubscriptionInvalidTagException() {
        super();
    }
     ...
     *  method.
     */
    public SubscriptionInvalidTagException(String message) {
        super(message);
    }
     ...
     */
    public SubscriptionInvalidTagException(Throwable cause) {
        super(cause);
    }
     ...
     *  value is permitted, and indicates that the cause is nonexistent or unknown.
     */
    public SubscriptionInvalidTagException(String message, Throwable cause) {
        super(message, cause);
    }
}
