...
/**
 * The SubscriptionInvalidTagException is used to reject an activation attempt for a
 *  * subscription.
 */
public class SubscriptionInvalidTagException extends SubscriptionServiceException {
     ...
     */
    public SubscriptionInvalidTagException(String dellAssetTag, String ownerKey) {
        super();
     ...
     *  method.
     */
    public SubscriptionInvalidTagException(String dellAssetTag, String ownerKey, String message) {
        super(message);
        this.dellAssetTag = dellAssetTag;
        this.ownerKey = ownerKey;
    }
     ...
     */
    public SubscriptionInvalidTagException(String dellAssetTag, String ownerKey, Throwable cause) {
        super(cause);
        this.dellAssetTag = dellAssetTag;
        this.ownerKey = ownerKey;
    }
