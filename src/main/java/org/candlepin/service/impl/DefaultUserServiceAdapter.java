...
public class DefaultUserServiceAdapter implements UserServiceAdapter {
    ...
    public List<? extends UserInfo> listUsers() {
        ...
        // This method uses secure criteria and will through a 403 which doesn't represent what we are testing.
    ...
    public UserInfo findByLogin(String login) {
        // This is to simulate the new changes to the adapters when they no longer use the user curator.
