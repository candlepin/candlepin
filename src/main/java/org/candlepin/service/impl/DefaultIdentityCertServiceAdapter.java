...
public class DefaultIdentityCertServiceAdapter implements IdentityCertServiceAdapter {
    ...
    @Override
    public IdentityCertificate generateIdentityCert(Consumer consumer) throws GeneralSecurityException {
    ...
    @Override
    public IdentityCertificate regenerateIdentityCert(Consumer consumer) throws GeneralSecurityException {
        IdentityCertificate certificate = null;
