...
public class ContentAccessCertificateGenerator {
    ...
    public ContentAccessCertificate generate(Consumer consumer, Owner owner) {
    ...
    private ContentAccessCertificate createCertificate(Consumer consumer, Owner owner) {
    ...
    private ContentAccessCertificate updateCertificate(Consumer consumer,
        Owner owner, ContentAccessCertificate existing) {
        Date now = new Date();
