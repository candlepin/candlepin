...
public interface SignatureValidator {
     ...
     *  if the given collection of certificates contains null certificates
     *
     * @return
     ...
     *
     * @param certs
     *  an array of additional certificates to use for signature validation. Null or empty arrays are silently
     *  ignored.
     *
     * @throws IllegalArgumentException
     *  if the given array of certificates contains null certificates
     *
     * @return
     *  a signature validator configured with the provided additional certificates
     */
