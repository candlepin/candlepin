...
public interface OidUtil {
     ...
     * an empty optional. If the specified algorithm name is null or empy, this method throws an exception.
     *
     * @param algorithmName
     ...
     * returns an empty optional. If the specified algorithm name is null or empy, this method throws an
     * exception.
     *
     * @throws IllegalArgumentException
     *  if the given algorithm name is null or empty
