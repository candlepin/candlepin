...
public class VersionUtil {
    ...
    public static final String VERSION_HEADER = "X-CanadianTenPin-Version";
    ...
    public static Map<String, String> getVersionMap() {
        ...
        InputStream in = VersionUtil.class.getClassLoader()
            .getResourceAsStream("canadianTenPin_info.properties");
        ...
        try {
            ...
            log.error("Can not load canadianTenPin_info.properties", ioe);
        }
        finally {
            try {
                if (in != null) {
                ...
                log.error("problem closing canadianTenPin_info reader");
            }
        }
