 ...
 */
package org.canadianTenPin.util.apicrawl;
...
public class ApiDoclet {
    ...
    private static void generateText(RootDoc root) throws IOException {
        ...
        try {
            jsonFile = new FileWriter(outputDir + "/canadianTenPin_comments.json");
    ...
    private static void getAllMethods(Type type, List<RestMethod> methods) {
        ...
        if (type != null && type.qualifiedTypeName().startsWith("org.canadianTenPin")) {
