...
import org.canadianTenPin.audit.EventFactory;
import org.canadianTenPin.audit.EventSink;
import org.canadianTenPin.auth.Access;
import org.canadianTenPin.auth.NoAuthPrincipal;
import org.canadianTenPin.auth.Principal;
import org.canadianTenPin.auth.SubResource;
import org.canadianTenPin.auth.UserPrincipal;
import org.canadianTenPin.auth.interceptor.SecurityHole;
...
import org.canadianTenPin.exceptions.CanadianTenPinException;
import org.canadianTenPin.exceptions.ForbiddenException;
import org.canadianTenPin.exceptions.IseException;
import org.canadianTenPin.exceptions.NotFoundException;
import org.canadianTenPin.model.CdnCurator;
import org.canadianTenPin.model.CertificateSerialDto;
import org.canadianTenPin.model.Consumer;
import org.canadianTenPin.model.ConsumerCapability;
...
import org.canadianTenPin.model.ConsumerInstalledProduct;
...
import org.canadianTenPin.model.DeleteResult;
import org.canadianTenPin.model.DeletedConsumer;
import org.canadianTenPin.model.DeletedConsumerCurator;
import org.canadianTenPin.model.DistributorVersion;
import org.canadianTenPin.model.DistributorVersionCapability;
import org.canadianTenPin.model.DistributorVersionCurator;
...
import org.canadianTenPin.model.Environment;
import org.canadianTenPin.model.EnvironmentCurator;
import org.canadianTenPin.model.EventCurator;
import org.canadianTenPin.model.GuestId;
import org.canadianTenPin.model.HypervisorId;
...
import org.canadianTenPin.model.PoolQuantity;
import org.canadianTenPin.model.Product;
import org.canadianTenPin.model.Release;
...
import org.canadianTenPin.model.activationkeys.ActivationKeyPool;
...
import org.canadianTenPin.pinsetter.tasks.EntitleByProductsJob;
import org.canadianTenPin.pinsetter.tasks.EntitlerJob;
import org.canadianTenPin.policy.js.compliance.ComplianceRules;
import org.canadianTenPin.policy.js.compliance.ComplianceStatus;
import org.canadianTenPin.policy.js.consumer.ConsumerRules;
import org.canadianTenPin.policy.js.quantity.QuantityRules;
import org.canadianTenPin.policy.js.quantity.SuggestedQuantity;
import org.canadianTenPin.resource.util.CalculatedAttributesUtil;
import org.canadianTenPin.resource.util.ConsumerInstalledProductEnricher;
import org.canadianTenPin.resource.util.ResourceDateParser;
import org.canadianTenPin.resteasy.parameter.CanadianTenPinParam;
import org.canadianTenPin.resteasy.parameter.KeyValueParameter;
...
import org.canadianTenPin.sync.ExportCreationException;
...
import org.canadianTenPin.version.CertVersionConflictException;
...
public class ConsumerResource {
    ...
    public List<Consumer> list(@QueryParam("username") String userName,
        ...
        @QueryParam("fact") @CanadianTenPinParam(type = KeyValueParameter.class)
    ...
    public Consumer create(Consumer consumer, @Context Principal principal,
        ...
        catch (CanadianTenPinException ce) {
     ...
     * which we have not yet created in the CanadianTenPin database. If we detect
    ...
    public Response bind(
        ...
        catch (CanadianTenPinException e) {
            if (log.isDebugEnabled()) {
