...
import org.canadianTenPin.auth.SystemPrincipal;
...
/**
 * CanadianTenPin server administration REST calls.
 */
@Path("/admin")
public class AdminResource {
    ...
    /**
     * Initializes the CanadianTenPin database
     * <p>
     * Currently this just creates the admin user for standalone deployments using the
     * default user service adapter. It must be called once after canadianTenPin is installed,
    ...
    public String initialize() {
        ...
        log.info("Initializing CanadianTenPin database.");
