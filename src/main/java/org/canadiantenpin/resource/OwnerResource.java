...
import org.canadianTenPin.model.ExporterMetadata;
import org.canadianTenPin.model.ExporterMetadataCurator;
import org.canadianTenPin.model.ImportRecord;
import org.canadianTenPin.model.ImportRecordCurator;
import org.canadianTenPin.model.ImportUpstreamConsumer;
import org.canadianTenPin.model.Owner;
import org.canadianTenPin.model.OwnerCurator;
import org.canadianTenPin.model.OwnerInfo;
import org.canadianTenPin.model.OwnerInfoCurator;
...
import org.canadianTenPin.model.PoolFilterBuilder;
import org.canadianTenPin.model.Statistic;
...
import org.canadianTenPin.pinsetter.tasks.HealEntireOrgJob;
...
import org.canadianTenPin.sync.ConflictOverrides;
import org.canadianTenPin.sync.Importer;
import org.canadianTenPin.sync.ImporterException;
import org.canadianTenPin.sync.Meta;
import org.canadianTenPin.sync.SyncDataFormatException;
...
public class OwnerResource {
    ...
    public List<Pool> listPools(
        ...
        @QueryParam("attribute") @CanadianTenPinParam(type = KeyValueParameter.class)
            List<KeyValueParameter> attrFilters,
     ...
     * <p>
     * Imports do carry rules and product information which is global to the canadianTenPin
    ...
    public void importManifest(
        ...
        // Grab canadianTenPin exceptions to record the error and then rethrow
