...
/**
 * Product data may originate from a separate service outside CanadianTenPin in some
 * configurations. This interface defines the operations CanadianTenPin requires
 * related to Product data, different implementations can handle whether or not
 * this info comes from CanadianTenPin's DB or from a separate service.
 */
