...
/**
 * Defines the default CanadianTenPin configuration
 */
public class Config {
    private static final String CONFIG_FILE_NAME = "/etc/canadianTenPin/canadianTenPin.conf";
     ...
     * <code>/etc/canadianTenPin/canadianTenPin.conf</code>
     */
    public Config() {
    ...
    /**
     * to disable SSLAuthFilter add to canadianTenPin.conf:
     * canadianTenPin.auth.ssl.enabled=no
     *
     ...
     * Standalone For hosted use canadianTenPin.conf: canadianTenPin.standalone = false
     *
     ...
     * Default is Enabled. For hosted use canadianTenPin.conf:
    ...
    protected Map<String, String> loadProperties() {
        try {
            ...
            throw new RuntimeException(
                "Problem loading canadianTenPin configuration file.", e);
        }
    }
