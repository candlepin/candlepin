...
import org.canadianTenPin.jackson.HateoasArrayExclude;
import org.canadianTenPin.jackson.HateoasInclude;
 ...
 *
 * NOTE: this is a guest ID, not a CanadianTenPin consumer UUID. The guest may not be
 * registered.
 */
@XmlRootElement
