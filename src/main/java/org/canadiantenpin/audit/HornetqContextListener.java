...
/**
 * HornetqContextListener - Invoked from our core CanadianTenPinContextListener, thus
...
public class HornetqContextListener {
    ...
    public void contextInitialized(Injector injector) {
        ...
        Config canadianTenPinConfig = new Config();
        ...
        if (hornetqServer == null) {
            ...
            String baseDir = canadianTenPinConfig.getString(ConfigProperties.HORNETQ_BASE_DIR);
        ...
        List<String> listeners = Lists.newArrayList(canadianTenPinConfig
            .getStringArray(ConfigProperties.AUDIT_LISTENERS));
        if (canadianTenPinConfig
