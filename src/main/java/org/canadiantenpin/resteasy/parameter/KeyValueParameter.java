 ...
 * KeyValueParameter
 */
public class KeyValueParameter extends CanadianTenPinParameter {
    ...
    @Override
    void parse() throws CanadianTenPinParamterParseException {
        String[] parts = this.paramValue.split(":", 2); // Maximum of two parts
        if (parts.length == 1) {
            throw new CanadianTenPinParamterParseException(this.paramName,
