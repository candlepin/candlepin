 ...
 * For example:
 *
 * @QueryParam("my_param") @CanadianTenPinParam(type=KeyValueParameter.class)
 * List<KeyValueParameter> attributeFileterParams
 * </pre>
 *
 * @see CanadianTenPinParameter
 */
@Retention(RetentionPolicy.RUNTIME)
@StringParameterUnmarshallerBinder(CanadianTenPinParameterUnmarshaller.class)
public @interface CanadianTenPinParam {
    Class<? extends CanadianTenPinParameter> type();
}
