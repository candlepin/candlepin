...
public class OAuth implements AuthProvider {
    ...
    public Principal getPrincipal(HttpRequest request) {
        ...
        try {
            ...
            String message = i18n.tr("OAuth problem encountered. Internal message is: {0}",
                e.getMessage());
            throw new CanadianTenPinException(returnCode, message);
        }
     ...
     * canadianTenPin.auth.oauth.consumer.CONSUMERNAME.secret = CONSUMERSECRET and
     * create consumers for them.
     */
    protected void setupAccessors() {
        String prefix = "canadianTenPin.auth.oauth.consumer";
