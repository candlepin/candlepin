...
import org.canadianTenPin.logging.LoggerContextListener;
...
/**
 * Customized CanadianTenPin version of
 ...
 */
public class CanadianTenPinContextListener extends
    ...
    private static Logger log = LoggerFactory.getLogger(CanadianTenPinContextListener.class);
    ...
    protected List<Module> getModules() {
        ...
        modules.add(new CanadianTenPinModule());
        modules.add(new CanadianTenPinFilterModule());
