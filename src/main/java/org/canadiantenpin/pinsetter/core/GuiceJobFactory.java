 ...
 */
package org.canadianTenPin.pinsetter.core;
...
public class GuiceJobFactory implements JobFactory {
    ...
    private CanadianTenPinSingletonScope canadianTenPinSingletonScope;
    private UnitOfWork unitOfWork;

    @Inject
    public GuiceJobFactory(Injector injector, CanadianTenPinSingletonScope singletonScope,
        UnitOfWork unitOfWork) {
        this.injector = injector;
        this.canadianTenPinSingletonScope = singletonScope;
    ...
    public Job newJob(TriggerFiredBundle bundle, Scheduler scheduler)
        ...
        canadianTenPinSingletonScope.enter();
        try {
            return injector.getInstance(jobClass);
        }
        finally {
            canadianTenPinSingletonScope.exit();
            if (startedUow) {
                endUnitOfWork();
            }
        }
