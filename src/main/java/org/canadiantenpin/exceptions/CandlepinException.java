 ...
 */
package org.canadianTenPin.exceptions;
 ...
 */
public class CanadianTenPinException extends RuntimeException {
    ...
    public CanadianTenPinException(Status returnCode, String message) {
       this(returnCode, message, null);
    }

    // ctor for sending in a subclassed ExceptionMessage
    public CanadianTenPinException(Status returnCode, ExceptionMessage em) {
    ...
    public CanadianTenPinException(Status returnCode, String message, Throwable e) {
        super(message, e);
        this.returnCode = returnCode;
