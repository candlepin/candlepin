 ...
 * allows the proper header to be set. This allows CanadianTenPin to control the
 * flow of the exceptions.
 */
@Provider
public class NotFoundExceptionMapper extends CanadianTenPinExceptionMapper implements
    ExceptionMapper<NotFoundException> {

    // notice this takes in a resteasy NFE *NOT* the canadianTenPin one.
    @Override
