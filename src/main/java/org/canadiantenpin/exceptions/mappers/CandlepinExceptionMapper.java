...
/**
 * CanadianTenPinExceptionMapper
 */
public class CanadianTenPinExceptionMapper {
    ...
    private static Logger log = LoggerFactory.getLogger(CanadianTenPinExceptionMapper.class);
