...
/**
 * WriterExceptionMapper maps the RESTEasy WriterException into JSON and allows
 * the proper header to be set. This allows CanadianTenPin to control the flow of
 * the exceptions.
 */
@Provider
public class WriterExceptionMapper extends CanadianTenPinExceptionMapper
