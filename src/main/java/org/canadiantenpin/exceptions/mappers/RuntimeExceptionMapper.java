...
import org.canadianTenPin.util.VersionUtil;
 ...
 * CanadianTenPinException) and maps into JSON and allows the proper header to be
 * set. This allows CanadianTenPin to control the flow of the exceptions.
 ...
 */
@Provider
public class RuntimeExceptionMapper extends CanadianTenPinExceptionMapper
    ...
    public Response toResponse(RuntimeException exception) {
        ...
        if (cause instanceof CanadianTenPinException) {
            bldr = getBuilder((CanadianTenPinException) cause, responseMediaType);
        }
        else if (exception instanceof CanadianTenPinException) {
            bldr = getBuilder((CanadianTenPinException) exception, responseMediaType);
        }
        else {
    ...
    protected ResponseBuilder getBuilder(CanadianTenPinException exception,
