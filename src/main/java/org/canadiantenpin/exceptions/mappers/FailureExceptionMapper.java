 ...
 * proper header to be set. This allows CanadianTenPin to control the flow of the
 * exceptions.
 */
@Provider
public class FailureExceptionMapper extends CanadianTenPinExceptionMapper
