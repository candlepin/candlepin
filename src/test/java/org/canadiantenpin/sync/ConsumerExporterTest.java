...
public class ConsumerExporterTest {
    ...
    public void testConsumerExport() throws IOException {
        ...
        ConsumerType ctype = new ConsumerType("canadianTenPin");
        ctype.setId("8888");
        ...
        exporter.export(mapper, writer, consumer, "/subscriptions", "/canadianTenPin");
        ...
        json.append("\"urlApi\":\"/canadianTenPin\"}");
