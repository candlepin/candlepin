...
/**
 * CanadianTenPinScopeFilterTest
 */
public class CanadianTenPinScopeFilterTest {

    private HttpServletRequest request;
    private HttpServletResponse response;
    private CanadianTenPinSingletonScope scope;
    private CanadianTenPinScopeFilter filter;
    ...
    public void init() {
        ...
        scope = mock(CanadianTenPinSingletonScope.class);
        filter = new CanadianTenPinScopeFilter(scope);
    }
