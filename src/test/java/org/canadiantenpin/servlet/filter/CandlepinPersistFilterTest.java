...
/**
 * CanadianTenPinPersistFilterTest
 */
public class CanadianTenPinPersistFilterTest {

    private CanadianTenPinPersistFilter filter;
    private UnitOfWork work;

    @Before
    public void init() {
        work = mock(UnitOfWork.class);
        filter = new CanadianTenPinPersistFilter(work);
    }
