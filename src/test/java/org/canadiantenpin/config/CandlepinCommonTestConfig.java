...
/**
 * CanadianTenPinCommonTestConfig
 */
public class CanadianTenPinCommonTestConfig extends Config {

    public CanadianTenPinCommonTestConfig() {
        super(new TreeMap<String, String>());
        // be very careful not to invoke the default Config ctor here
        // because it will read in your /etc/canadianTenPin/canadianTenPin.conf
    ...
    protected Map<String, String> loadProperties() {
        ...
        try {
            String cert = getClass().getResource("canadianTenPin-ca.crt").toURI().getPath();
            String key = getClass().getResource("canadianTenPin-ca.key").toURI().getPath();
