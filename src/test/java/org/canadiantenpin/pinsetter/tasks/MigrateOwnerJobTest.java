...
public class MigrateOwnerJobTest {
    ...
    public void init() {
        ...
        conn = mock(CanadianTenPinConnection.class);
    ...
    public void testMigrateOwner() {
        JobDetail jd = MigrateOwnerJob.migrateOwner("admin",
            "http://foo.example.com/canadianTenPin", false);
        assertNotNull(jd);
        assertNotNull(jd.getJobDataMap());
        assertEquals("admin", jd.getJobDataMap().get("owner_key"));
        assertEquals("http://foo.example.com/canadianTenPin",
    ...
    public void nullOwner() {
        MigrateOwnerJob.migrateOwner(null, "http://foo.example.com/canadianTenPin",
            false);
    }
    ...
    public void execute() throws JobExecutionException {
        ...
        map.put("uri", "http://foo.example.com/canadianTenPin");
        map.put("delete", true);
        ...
        verify(conn).connect(eq(OwnerClient.class), any(Credentials.class),
            eq("http://foo.example.com/canadianTenPin"));
    ...
    public void executeInvalidKey() throws JobExecutionException {
        JobDataMap map = new JobDataMap();
        map.put("owner_key", "admin");
        map.put("badurikey", "http://foo.example.com/canadianTenPin");
        ...
        public ConfigForTesting() {
            super(new HashMap<String, String>() {
                private static final long serialVersionUID = 1L;
                {
                    ...
                    this.put(ConfigProperties.SHARD_WEBAPP, "canadianTenPin");
                }
            });
        }
    }
