 ...
 */
package org.canadianTenPin.service.impl.test;
...
import org.canadianTenPin.model.Content;
...
import org.canadianTenPin.model.EnvironmentContent;
import org.canadianTenPin.model.KeyPairCurator;
...
import org.canadianTenPin.model.ProductContent;
...
import org.canadianTenPin.pki.X509ByteExtensionWrapper;
import org.canadianTenPin.pki.X509ExtensionWrapper;
...
import org.canadianTenPin.util.CertificateSizeException;
import org.canadianTenPin.util.Util;
import org.canadianTenPin.util.X509ExtensionUtil;
import org.canadianTenPin.util.X509V3ExtensionUtil;
import org.canadianTenPin.util.X509V3ExtensionUtil.HuffNode;
import org.canadianTenPin.util.X509V3ExtensionUtil.NodePair;
import org.canadianTenPin.util.X509V3ExtensionUtil.PathNode;
...
public class DefaultEntitlementCertServiceAdapterTest {
    ...
    @Before
    public void setUp() {
        Config config = new CanadianTenPinCommonTestConfig();
    ...
    public void ensureV3CertIsCreatedWhenV3CapabilityPresent() throws Exception {
        ...
        when(consumer.getType()).thenReturn(
            new ConsumerType(ConsumerType.ConsumerTypeEnum.CANADIAN_TEN_PIN));
...
//        assertEquals(order.get("account"), subscription.getAccountNumber());
    ...
    public void testPathTreeCommonHeadAndTail() {
        List<org.canadianTenPin.json.model.Content> contentList =
            new ArrayList<org.canadianTenPin.json.model.Content>();
        for (int i = 0; i < 20; i++) {
            org.canadianTenPin.json.model.Content cont =
                new org.canadianTenPin.json.model.Content();
    ...
    public void testPathTreeSortsChildNodesAlphabetically() {
        ...
        org.canadianTenPin.json.model.Content contentA = new org.canadianTenPin.json.model.Content();
        contentA.setPath("/AAA");
        org.canadianTenPin.json.model.Content contentB = new org.canadianTenPin.json.model.Content();
        contentB.setPath("/BBB");
        org.canadianTenPin.json.model.Content contentC = new org.canadianTenPin.json.model.Content();
    ...
    public void testPathDictionary() throws IOException {
        List<org.canadianTenPin.json.model.Content> contentList =
            new ArrayList<org.canadianTenPin.json.model.Content>();
        org.canadianTenPin.json.model.Content cont = null;
        for (int i = 0; i < 20; i++) {
            cont = new org.canadianTenPin.json.model.Content();
            cont.setPath("/head/neck/shoulders/heart" + i + "/waist" +
                i + "/leg/foot/heel");
            contentList.add(cont);
        }
