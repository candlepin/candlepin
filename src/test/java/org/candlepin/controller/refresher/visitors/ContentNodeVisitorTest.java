...
public class ContentNodeVisitorTest extends DatabaseTestFixture {
    ...
    public void testFullCyclePersistsNewEntity() {
        ...
        Content fetchedEntity = this.ownerContentCurator.getContentById(owner, content.getId());
    ...
    public void testFullCyclePersistsUpdatedEntity() {
        ...
        Content fetchedEntity = this.ownerContentCurator.getContentById(owner, existing.getId());
        assertNotNull(fetchedEntity);
