...
public class RhsmApiCompatResourceTest extends DatabaseTestFixture {
    ...
    @Test
    public void testListConsumerEntitlementCountsWithMissingPageParameter() {
        Owner owner = this.createOwner();
        ...
        assertThat(actual)
            .isNotNull()
            .hasSize(numberOfConsumers);

        actual = rhsmApiCompatResource
            .listConsumerEntitlementCounts(body, null, 2);
