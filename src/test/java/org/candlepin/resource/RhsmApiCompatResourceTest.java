...
public class RhsmApiCompatResourceTest extends DatabaseTestFixture {
    ...
    public void testGetConsumerFeedWithNotValidOwner(String ownerKey) {
        Stream<ConsumerFeedDTO> consumerFeed = rhsmApiCompatResource.getConsumerFeed(ownerKey, null, null,
            null, null, null);
    ...
    public void testGetConsumerFeedWithUnknownOwner() {
        Stream<ConsumerFeedDTO> consumerFeed = rhsmApiCompatResource.getConsumerFeed("unknowKey", null, null,
            null, null, null);
    ...
    public void testGetConsumerFeedWithInvalidPageParameter() {
        ...
        assertThrows(BadRequestException.class, () -> rhsmApiCompatResource.getConsumerFeed("test-owner",
