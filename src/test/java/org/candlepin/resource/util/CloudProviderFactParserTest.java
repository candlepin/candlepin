...
public class CloudProviderFactParserTest {
    ...
    public void testGetAccountId(CloudProviderFactParser parser, CloudProviderFactParserArgument argument) {
    ...
    @ParameterizedTest
    @MethodSource("provideTestData")
    public void testGetInstanceId(CloudProviderFactParser parser, CloudProviderFactParserArgument argument) {
    ...
    @ParameterizedTest
    @MethodSource("provideTestData")
    public void testGetOfferingIds(CloudProviderFactParser parser, CloudProviderFactParserArgument argument) {
    ...
    @ParameterizedTest
    @MethodSource("provideTestData")
    public void testIsSupported(CloudProviderFactParser parser, CloudProviderFactParserArgument argument) {
