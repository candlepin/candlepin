...
class KeyPairGeneratorTest {
    ...
    public void testGenerateKeyPair() {
        KeyPairGenerator generator = new KeyPairGenerator(this.securityProvider, this.keypairCurator);
    ...
    @Test
    public void testGetConsumerKeyPairRegneratesMalformedKeyPairs() {
        KeyPairGenerator generator = new KeyPairGenerator(this.securityProvider, this.keypairCurator);
