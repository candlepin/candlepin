...
public abstract class OidUtilTest {
    ...
    @Test
    public void testGetKeyAlgorithmOidAcceptsEmptyInput() {
        OidUtil oidUtil = this.buildOidUtil();

        assertThat(oidUtil.getKeyAlgorithmOid(""))
            .isNotNull()
            .isEmpty();
    }

    @Test
    public void testGetKeyAlgorithmOidRejectsNullInput() {
        OidUtil oidUtil = this.buildOidUtil();

        assertThrows(IllegalArgumentException.class, () -> oidUtil.getKeyAlgorithmOid(null));
    }
    ...
    @Test
    public void testGetKeyAlgorithmNameAcceptsEmptyInput() {
        OidUtil oidUtil = this.buildOidUtil();

        assertThat(oidUtil.getKeyAlgorithmName(""))
            .isNotNull()
            .isEmpty();
    }

    @Test
    public void testGetKeyAlgorithmNameRejectsNullInput() {
        OidUtil oidUtil = this.buildOidUtil();

        assertThrows(IllegalArgumentException.class, () -> oidUtil.getKeyAlgorithmName(null));
    }
    ...
    @Test
    public void testGetSignatureAlgorithmOidAcceptsEmptyInput() {
        OidUtil oidUtil = this.buildOidUtil();

        assertThat(oidUtil.getSignatureAlgorithmOid(""))
            .isNotNull()
            .isEmpty();
    }

    @Test
    public void testGetSignatureAlgorithmOidRejectsNullInput() {
        OidUtil oidUtil = this.buildOidUtil();

        assertThrows(IllegalArgumentException.class, () -> oidUtil.getSignatureAlgorithmOid(null));
    }
    ...
    @Test
    public void testGetSignatureAlgorithmNameAcceptsEmptyInput() {
        OidUtil oidUtil = this.buildOidUtil();

        assertThat(oidUtil.getSignatureAlgorithmName(""))
            .isNotNull()
            .isEmpty();
    }

    @Test
    public void testGetSignatureAlgorithmNameRejectsNullInput() {
        OidUtil oidUtil = this.buildOidUtil();

        assertThrows(IllegalArgumentException.class, () -> oidUtil.getSignatureAlgorithmName(null));
    }
    ...
    public void testIsAlgorithmSupportedRequiresNonNullTestAlgorithmOid() {
        OidUtil oidUtil = this.buildOidUtil();
        Set<String> algorithmOids = Set.of("1.2.3", "1.2.4", "1.2.5");

        assertThrows(IllegalArgumentException.class, () -> oidUtil.isAlgorithmSupported(algorithmOids, null));
    }

    @ParameterizedTest
    @ValueSource(strings = { "", " ", "\t" })
    public void testIsAlgorithmSupportedAllowsEmptyTestAlgorithmOid(String algorithmOid) {
        // If an empty or blank test algorithm OID is provided, the method should still function, but it
        // should return false.
