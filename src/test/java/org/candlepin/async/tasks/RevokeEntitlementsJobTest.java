...
public class RevokeEntitlementsJobTest {
    ...
    @NullAndEmptySource
    public void testRevokeEntitlementsJobConfigSetOwnerKeyWithInvalidKey(String ownerKey)
        throws JobExecutionException {
        RevokeEntitlementsJobConfig jobConfig = new RevokeEntitlementsJobConfig();

        assertThrows(IllegalArgumentException.class, () -> jobConfig.setOwnerKey(ownerKey));
    }
