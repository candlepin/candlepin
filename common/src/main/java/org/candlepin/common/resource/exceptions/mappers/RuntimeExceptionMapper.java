...
public class RuntimeExceptionMapper extends CandlepinExceptionMapper
    ...
    public Response toResponse(RuntimeException exception) {
        ...
        if (cause instanceof RestApiException) {
            bldr = getBuilder((RestApiException) cause, responseMediaType);
        }
        else if (exception instanceof RestApiException) {
            bldr = getBuilder((RestApiException) exception, responseMediaType);
        }
        else {
    ...
    protected ResponseBuilder getBuilder(RestApiException exception, MediaType responseMediaType) {
