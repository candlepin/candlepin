...
public class OwnerDTOBuilder {
    ...
    // withers...
    public OwnerDTOBuilder withContentAccess(String contentAccessMode) {
        this.contentAccessMode = contentAccessMode;
        return this;
    }

    public OwnerDTOBuilder withContentAccessList(String contentAccessModeList) {
        this.contentAccessModeList = contentAccessModeList;
        return this;
    }

    public OwnerDTOBuilder scaEnabled() {
        this.withContentAccess("org_environment")
            .withContentAccessList("org_environment,entitlement");
        return this;
    }

    public OwnerDTOBuilder withParent(NestedOwnerDTO parentOwner) {
