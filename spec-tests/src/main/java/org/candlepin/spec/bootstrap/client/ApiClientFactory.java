...
public class ApiClientFactory {
    ...
    private OkHttpClient createOkHttpClient(Interceptor... interceptors) {
        ...
        try {
            // Install the all-trusting trust manager and
    ...
    public OkHttpClient createmTLSOkHttpClient(String cert) {
        try {
            ...
            try (PEMParser pemParser = new PEMParser(new StringReader(cert))) {
                Object object;
            ...
            throw new RuntimeException("Failed to create mTLS client with X.509 certificate", e);
        }
    }
