...
public class RhsmApiCompatResourceSpecTest {
    ...
    public void shouldNotAllowNonAdminUsersToGetConsumerFeed() {
        ...
        assertForbidden(() -> userClient.rhsmApi().getConsumerFeed("randomOrg", null, null, null, null
            , null));
    }
    ...
    public void shouldNotAllowNoAuthClientsToGetConsumerFeed() {
        ...
        assertUnauthorized(() -> noAuthClient.rhsmApi().getConsumerFeed("randomOrg", null, null, null, null
            , null));
    }
    ...
    public void shouldGetConsumerFeed() {
        ...
        List<ConsumerFeedDTO> consumerFeed = adminClient.rhsmApi()
            .getConsumerFeed(ownerKey, null, null, null, null, null);
    ...
    public void shouldGetConsumerFeedIdFilter() {
        ...
        List<ConsumerFeedDTO> consumerFeed = adminClient.rhsmApi()
            .getConsumerFeed(ownerKey, consumer1.getId(), null, null, null, null);
    ...
    public void shouldGetConsumerFeedUuidFilter() {
        ...
        List<ConsumerFeedDTO> consumerFeed = adminClient.rhsmApi()
            .getConsumerFeed(ownerKey, null, consumer1.getUuid(), null, null, null);
    ...
    public void shouldGetConsumerFeedAfterCheckinFilter() {
        ...
        List<ConsumerFeedDTO> consumerFeed = adminClient.rhsmApi()
            .getConsumerFeed(ownerKey, null, null, consumer2.getLastCheckin().plusMinutes(1), null, null);

        assertThat(consumerFeed)
            .isNotNull()
            .hasSize(1)
            .extracting(ConsumerFeedDTO::getId)
            .containsExactlyInAnyOrder(consumer3.getId());
    }
    ...
    public void shouldGetConsumerFeedAllFiltersCombined() {
        ...
        List<ConsumerFeedDTO> consumerFeed = adminClient.rhsmApi()
            .getConsumerFeed(ownerKey, consumer3.getId(), consumer2.getUuid(),
        ...
        assertThat(consumerFeed)
            ...
            .hasSize(1)
            .extracting(ConsumerFeedDTO::getId)
            .containsExactly(consumer4.getId());
    }
    ...
    public void shouldGetConsumerFeedWithInstalledProducts() {
        ...
        assertThat(consumerFeed)
            .isNotNull()
            .hasSize(1)
            .extracting(ConsumerFeedDTO::getInstalledProducts)
            .containsExactly(Set.of(Products.toConsumerFeedInstalled(product)));
    }
    ...
    public void shouldGetConsumerFeedWithFacts() {
        ...
        assertThat(consumerFeed)
            .isNotNull()
            .hasSize(1)
            .extracting(ConsumerFeedDTO::getFacts)
            .containsExactly(Map.of("cpu.cpu_socket(s)", "2", "network.fqdn", "host.redhat.com"));
    }
    ...
    public void shouldGetConsumerFeedWithAddons() {
        ...
        assertThat(consumerFeed)
            .isNotNull()
            .hasSize(1)
            .extracting(ConsumerFeedDTO::getSyspurposeAddons)
            .containsExactly(addOns);
    }
    ...
    public void shouldGetConsumerFeedWithHypervisorsAndGuests() {
        ...
        List<ConsumerFeedDTO> actual = admin.rhsmApi()
            .getConsumerFeed(owner.getKey(), null, null, null, null, null);
    ...
    public void shouldGetConsumerFeedWithAllAttributesAndFiltersCorrectlyApplied() {
        ...
        List<ConsumerFeedDTO> actual = admin.rhsmApi().getConsumerFeed(
        ...
        ConsumerFeedDTO feed = actual.get(0);

        assertThat(feed.getGuestId()).isEqualTo(host2Guest2VirtUuid);
        assertThat(feed.getHypervisorUuid()).isEqualTo(host2.getUuid());
        assertThat(feed.getHypervisorName()).isEqualTo(host2.getName());
        assertThat(feed.getFacts())
            .containsAllEntriesOf(
                Map.of("cpu.cpu_socket(s)", "2",
                    "uname.machine", "x86_64",
                    "virt.is_guest", "true")
            );
        assertThat(feed.getSyspurposeAddons())
            .containsExactlyInAnyOrderElementsOf(addons);
        assertThat(feed.getInstalledProducts())
            .containsExactly(Products.toConsumerFeedInstalled(product));
    }
