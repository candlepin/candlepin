...
import org.candlepin.dto.api.client.v1.ConsumerEntitlementCountsDTOAllOfEntitlementCounts;
...
public class RhsmApiCompatResourceSpecTest {
    ...
    public void shouldNotAllowNonAdminUsersToListEntitlementCountsForConsumers() {
        ...
        assertForbidden(() -> userClient.rhsmApi().listConsumerEntitlementCounts(body, null, null));
    }
    ...
    public void shouldNotAllowNoAuthClientsToListEntitlementCountsForConsumers() {
        ...
        assertUnauthorized(() -> noAuthClient.rhsmApi().listConsumerEntitlementCounts(body, null, null));
    }
    ...
    public void shouldReturnBadRequestForExceedingConsumerUuidLimitWhenListingEntCountsForConsumers() {
        ...
        assertBadRequest(() -> adminClient.rhsmApi().listConsumerEntitlementCounts(body, null, null));
    }
    ...
    public void shouldListEntitlementCountsForConsumers() {
        ...
        List<ConsumerEntitlementCountsDTO> actual = adminClient.rhsmApi()
            .listConsumerEntitlementCounts(body, null, null);
        ...
        assertThat(actual.get(0))
            ...
            .extracting(ConsumerEntitlementCountsDTO::getEntitlementCounts,
                as(collection(ConsumerEntitlementCountsDTOAllOfEntitlementCounts.class)))
    ...
    public class ListEntitlementCountsPagingTests {
        ...
        @Test
        public void shouldPageEntitlementCounts() {
            int pageSize = 5;
            ...
            for (int pageIndex = 1; pageIndex * pageSize <= numberOfConsumers; pageIndex++) {
                ...
                List<String> consumerUuids = adminClient.rhsmApi()
                    .listConsumerEntitlementCounts(body, pageIndex, pageSize)
                    .stream()
        ...
        public void shouldFailWithInvalidPage(int page) {
            ...
            assertBadRequest(() -> adminClient.rhsmApi().listConsumerEntitlementCounts(body, page, 5));
        }

        @Test
        public void shouldReturnBadRequestWithNegativePageIndexValue() {
            RhsmApiConsumerEntitlementCountsQueryDTO body = new RhsmApiConsumerEntitlementCountsQueryDTO()
                .addConsumerIdsItem(StringUtil.random("id-"));

            assertBadRequest(() -> adminClient.rhsmApi().listConsumerEntitlementCounts(body, -1, 5));
        ...
        public void shouldFailWithInvalidPageSize(int pageSize) {
            ...
            assertBadRequest(() -> adminClient.rhsmApi().listConsumerEntitlementCounts(body, 1, -1));
        }

        @Test
        public void shouldNotPageWithOnlyPageIndex() {
            RhsmApiConsumerEntitlementCountsQueryDTO body = new RhsmApiConsumerEntitlementCountsQueryDTO()
                .consumerUuids(consumerUuids);

            List<String> actual = adminClient.rhsmApi()
                .listConsumerEntitlementCounts(body, 1, null)
                .stream()
                .map(ConsumerEntitlementCountsDTO::getConsumerUuid)
                .toList();
        ...
        @Test
        public void shouldNotPageWithOnlyPerPage() {
            RhsmApiConsumerEntitlementCountsQueryDTO body = new RhsmApiConsumerEntitlementCountsQueryDTO()
                .consumerUuids(consumerUuids);

            List<String> actual = adminClient.rhsmApi()
                .listConsumerEntitlementCounts(body, null, 5)
                .stream()
                .map(ConsumerEntitlementCountsDTO::getConsumerUuid)
                .toList();
