...
public class ContentResourceSpecTest {
    ...
    public class ContentResourceQueryTests {
        ...
        public void shouldAllowFilteringOnInvalidIds(String cid) {
            ...
            assertThat(output)
                .isNotNull()
                .map(ContentDTO::getId)
                .containsAll(List.of(expectedCid))
                .doesNotContainAnyElementsOf(this.getUnexpectedIds(List.of(expectedCid)));
        }
        ...
        public void shouldAllowFilteringOnLabel() {
            ...
            List<ContentDTO> output = this.adminClient.content()
                .getContents(null, null, contentLabels, INCLUSION_INCLUDE, INCLUSION_INCLUDE);
