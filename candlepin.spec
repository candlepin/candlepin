...
- change serials -> serialIds (jesusr@redhat.com)
- change log.info -> log.debug (jesusr@redhat.com)
...
- ownerinfo: use pool.getProductAttribute rather than the product adapter (jbowes@redhat.com)
- remove ownerinfo.poolNearestToExpiry; it's not used. (jbowes@redhat.com)
- Add ability to remove a cert from the certificate revocation list (CRL). (jesusr@redhat.com)
- Bind a LoggingConfig here so we set log levels for tests (alikins@redhat.com)
- Add API method to refresh pools for owner of specific products. (awood@redhat.com)
...
* Mon Aug 13 2012 jesus m. rodriguez <jesusr@redhat.com> 0.7.6.2-1
