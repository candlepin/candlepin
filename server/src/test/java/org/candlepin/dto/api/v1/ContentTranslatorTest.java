...
public class ContentTranslatorTest extends
    ...
    protected void initFactory(DTOFactory factory) {
        factory.registerTranslator(Content.class, this.translator);
    }

    @Override
    protected ContentTranslator initTranslator() {
        return this.translator;
    }

    @Override
    protected Content initSourceEntity() {
    ...
    @Override
    protected ContentDTO initDestDTO() {
        // Nothing fancy to do here.
        return new ContentDTO();
    }

    @Override
    protected void verifyDTO(Content source, ContentDTO dto, boolean childrenGenerated) {
        if (source != null) {
