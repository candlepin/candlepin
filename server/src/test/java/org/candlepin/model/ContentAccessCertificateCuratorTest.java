...
class ContentAccessCertificateCuratorTest extends DatabaseTestFixture {
    ...
    public void nothingToDelete() {
        ...
        assertEquals(0, this.caCertCurator.deleteByIds(Arrays.asList()));
        assertEquals(0, this.caCertCurator.deleteByIds(Arrays.asList("UnknownId")));
    }

    private ContentAccessCertificate createCertificate(Consumer consumer, String cert) {
        return createCertificate(consumer, cert, TestUtil.createFutureDate(2));
    }
