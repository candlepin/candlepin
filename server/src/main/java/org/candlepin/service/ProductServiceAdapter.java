 ...
 *
 * Candlepin will validate any input parameters before the interface methods
 * are called. Any exceptions thrown by an implementation, will be appropriately
 * handled by Candlepin.
 */
