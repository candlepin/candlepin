...
public class HostedTestSubscriptionResource {
    ...
    public ProductInfo createProduct(ProductDTO product) {
        ...
        return this.adapter.createProduct(InfoAdapter.productInfoAdapter(product));
    }
    ...
    public ProductInfo updateProduct(
        ...
        return this.adapter.updateProduct(productId, InfoAdapter.productInfoAdapter(update));
    }
    ...
    public ContentInfo createContent(ContentDTO content) {
        ...
        return this.adapter.createContent(InfoAdapter.contentInfoAdapter(content));
    }
    ...
    public ContentInfo updateContent(
        ...
        return this.adapter.updateContent(contentId, InfoAdapter.contentInfoAdapter(update));
    }
