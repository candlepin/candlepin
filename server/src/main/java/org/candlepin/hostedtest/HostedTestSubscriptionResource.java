...
public class HostedTestSubscriptionResource {
    ...
    public ProductInfo createProduct(ProductDTO product) {
        ...
        return this.adapter.createProduct(productInfoAdapter(product));
    }
    ...
    public ProductInfo updateProduct(
        ...
        return this.adapter.updateProduct(productId, productInfoAdapter(update));
    }
    ...
    public ContentInfo createContent(ContentDTO content) {
        ...
        return this.adapter.createContent(contentInfoAdapter(content));
    }
    ...
    public ContentInfo updateContent(
        ...
        return this.adapter.updateContent(contentId, contentInfoAdapter(update));
    }
