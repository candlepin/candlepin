...
public class OwnerProductResource {
    ...
    public CandlepinQuery<ProductDTO> listProducts(
        ...
        return this.dtoFactory.<Product, ProductDTO>transformQuery(query);
    }
    ...
    public ProductDTO getProduct(
        ...
        return this.dtoFactory.<Product, ProductDTO>buildDTO(product);
    }
    ...
    public ProductDTO createProduct(
        ...
        return this.dtoFactory.<Product, ProductDTO>buildDTO(entity);
    }
    ...
    public ProductDTO updateProduct(
        ...
        return this.dtoFactory.<Product, ProductDTO>buildDTO(updated);
    }
    ...
    public ProductDTO addBatchContent(
        ...
        for (Entry<String, Boolean> entry : contentMap.entrySet()) {
            ...
            ContentDTO cdto = this.dtoFactory.<Content, ContentDTO>buildDTO(content);
