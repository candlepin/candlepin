...
public class EnvironmentResource implements EnvironmentsApi {
    ...
    public AsyncJobStatusDTO promoteContent(@Verify(Environment.class) String envId,
        ...
        return regenCertificates(env, contentIds, lazyRegen);
    }
    ...
    public AsyncJobStatusDTO demoteContent(@Verify(Environment.class) String envId,
        ...
        try {
            ...
            clearContentAccessCerts(environment);
        }
    ...
    private AsyncJobStatusDTO regenCertificates(Environment env, Set<String> contentIds, Boolean lazyRegen) {
     ...
     */
    @Transactional
    public Set<String>  batchCreate(List<ContentToPromoteDTO> contentToPromote,
        Environment env) {
