 ...
 */
public class IterableStreamingOutput<T> implements StreamingOutput, Iterable {
    ...
    /**
     * Retrieves an iterator containing the data to be streamed. If a transform has been applied,
     * the elements returned by the iterator will be transformed accordingly.
     * <p></p>
     * <strong>Note:</strong> The iterator returned by this method backs this streaming output
     * instance. Changes made to the iterator's state will affect the output generated by this
     * object.
     *
     * @return
     *  The iterator containing the data to be streamed
     */
    @Override
    public Iterator<?> iterator() {
        return new Iterator() {
            ...
            @Override
            public Object next() {
                Iterator iterator = IterableStreamingOutput.this.iterator;
                IteratorTransformer transformer = IterableStreamingOutput.this.transformer;

                return transformer != null ? transformer.transform(iterator.next()) : iterator.next();
            }

            @Override
            public void remove() {
                IterableStreamingOutput.this.iterator.remove();
            }
        };
    }
     ...
     */
    public IterableStreamingOutput<T> setTransformer(IteratorTransformer<T, ?> transformer) {
