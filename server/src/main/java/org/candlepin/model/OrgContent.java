...
@Entity
@Table(name = "cp_org_content")
public class OrgContent extends AbstractHibernateObject {
    ...
    @ManyToOne
    @ForeignKey(name = "fk_content_owner")
    @JoinColumn(nullable = false)
    @Index(name = "cp_content_owner_fk_idx")
    @NotNull
    private Owner owner;
    ...
    public OrgContent(String name, String id, String label, String type,
    ...
    public static OrgContent createUeberOrgContent(
        UniqueIdGenerator idGenerator, Owner o, Product p) {

        return new OrgContent(
            UEBER_CONTENT_NAME, idGenerator.generateId(),
            ueberOrgContentLabelForProduct(p), "yum", "Custom",
            "/" + o.getKey(), "", "");
    }
    ...
    public boolean equals(Object other) {
        ...
        if (other instanceof OrgContent) {
            OrgContent that = (OrgContent) other;
    ...
    public static String ueberOrgContentLabelForProduct(Product p) {
    ...
    /**
     * @param from OrgContent object to copy properties from.
     * @return current OrgContent object with updated properties
     */
    public OrgContent copyProperties(OrgContent from) {
    ...
    public String toString() {
        return "OrgContent [id: " + getId() + ", label: " + getLabel() + "]";
    }
