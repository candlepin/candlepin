...
public final class OIDUtil {
    ...
    public static final Map<String, String> SERVER_ENTITLEMENT_NAMESPACES = new HashMap<>();
    public static final Map<String, String> CONTENT_ARCHITECTURES = new HashMap<>();
    public static final Map<String, String> CHANNEL_FAMILY_OIDS = new HashMap<>();
    public static final Map<String, String> CHANNEL_OIDS = new HashMap<>();
    public static final Map<String, String> CF_REPO_TYPE = new HashMap<>();
