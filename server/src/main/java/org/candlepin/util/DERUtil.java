...
public class DERUtil {
    ...
    public static final int SEQUENCE_OF        = 0x10; // used to model a SEQUENCE of the same type.
    public static final int SET                = 0x11; // decimal 17
    public static final int SET_OF             = 0x11; // used to model a SET of the same type.
