        ...
        while (productids.next()) {
            ...
            while (attributes.next()) {
                this.executeUpdate(
                    ...
                    "VALUES(?, ?, ?, ?, ?, ?)",
                    Util.generateDbUUID(), attributes.getDate(2), attributes.getDate(3),
            ...
            while (certificates.next()) {
                this.executeUpdate(
                    ...
                    "VALUES(?, ?, ?, ?, ?, ?)",
                    Util.generateDbUUID(), certificates.getDate(2), certificates.getDate(3),
                ...
                if (contentuuid == null) {
                    ...
                    while (content.next()) {
                        this.executeUpdate(
                            ...
                            "VALUES(?, ?, ?, ?, ?, ?)",
                            Util.generateDbUUID(), content.getDate(2), content.getDate(3),
        ...
        while (subscriptionids.next()) {
            ...
            while (sourcesub.next()) {
                this.executeUpdate(
                    ...
                    "VALUES(?, ?, ?, ?, ?, ?)",
                    Util.generateDbUUID(), subuuid, sourcesub.getString(3),
