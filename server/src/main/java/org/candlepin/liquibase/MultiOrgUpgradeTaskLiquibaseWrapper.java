...
/**
 * The MultiOrgUpgradeTaskLiquibaseWrapper class wraps the MultiOrgUpgradeTask to allow it to be
 * programatically performed via Liquibase.
 */
public class MultiOrgUpgradeTaskLiquibaseWrapper implements CustomTaskChange {
    ...
    public void execute(Database db) throws CustomChangeException {
        MultiOrgUpgradeTask task = new MultiOrgUpgradeTask(
            (JdbcConnection) db.getConnection(),
