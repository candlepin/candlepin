...
- 1321630: Breaks up queries into smaller ones that will not exceed stack depth
  on hypervisor checkin (csnyder@redhat.com)
...
- 1301812: Fixed an issue with event generation for stack derived pools
  (crog@redhat.com)
- Fixing broken tests due to expiry date (mstead@redhat.com)
...
* Tue Jun 02 2015 Devan Goodwin <dgoodwin@rm-rf.ca> 0.9.49.2-1
