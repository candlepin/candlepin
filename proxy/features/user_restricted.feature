Feature: Filter Entitlement Pools on "user_restricted" attribute
  ...
  Scenario: Restricted product for the correct user
    ...
    And I have a pool of quantity 5 for "Great Product" with the following attributes:
        | Name            | Value    |
        | user_restricted | billy003 |
  ...
  Scenario: Restricted product is filtered out
    ...
    And I have a pool of quantity 5 for "test-product" with the following attributes:
        | Name            | Value    |
        | user_restricted | ann_h    |
  ...
  Scenario: Mix of restricted and unrestricted
    ...
    And I have a pool of quantity 7 for "my-product" with the following attributes:
        | Name            | Value    |
        | user_restricted | billy003 |
    And I have a pool of quantity 1 for "not-mine" with the following attributes:
        | Name            | Value |
        | user_restricted | bob   |
