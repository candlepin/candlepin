...
public class DefaultCandlepinClientFacade implements CandlepinClientFacade {
     ...
     * (non-Javadoc)
     * @see
     * org.candlepin.client.CandlepinClientFacade#isRegistered()
     */
    ...
    /*
     * (non-Javadoc)
     * @see org.candlepin.client.CandlepinClientFacade#getUUID()
     */
     ...
     * (non-Javadoc)
     * @see
     * org.candlepin.client.CandlepinClientFacade#register(java
     ...
     * (non-Javadoc)
     * @see
     * org.candlepin.client.CandlepinClientFacade#updateConsumer
     ...
     * (non-Javadoc)
     * @see
     * org.candlepin.client.CandlepinClientFacade#registerExisting
     ...
     * (non-Javadoc)
     * @see
     * org.candlepin.client.CandlepinClientFacade#unRegister()
     */
    ...
    /*
     * (non-Javadoc)
     * @see org.candlepin.client.CandlepinClientFacade#listPools()
     */
     ...
     * (non-Javadoc)
     * @see
     * org.candlepin.client.CandlepinClientFacade#bindByProductId
     ...
     * (non-Javadoc)
     * @see
     * org.candlepin.client.CandlepinClientFacade#bindByRegNumber
     * (java.lang.String, int)
     */
    ...
    /*
     * (non-Javadoc)
     * @see org.candlepin.client.CandlepinClientFacade#unBindAll()
     */
    ...
    /*
     * (non-Javadoc)
     * @seeorg.candlepin.client.CandlepinClientFacade#
