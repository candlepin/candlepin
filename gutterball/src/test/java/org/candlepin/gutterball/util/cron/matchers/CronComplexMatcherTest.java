...
/**
 * CronComplexMatcherTest
 */
@RunWith(JUnitParamsRunner.class)
public class CronComplexMatcherTest {

    private CronComplexMatcher matcher;

    @Before
    public void setup() {
        this.matcher = new CronComplexMatcher();

        this.matcher.add(new CronStaticValueMatcher(1));
        this.matcher.add(new CronStaticValueMatcher(2));
        this.matcher.add(new CronStaticValueMatcher(3));
        this.matcher.add(new CronStaticValueMatcher(4));
        this.matcher.add(new CronStaticValueMatcher(5));
    }
