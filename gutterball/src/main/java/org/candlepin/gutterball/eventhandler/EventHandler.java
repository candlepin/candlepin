...
public interface EventHandler {
    ...
    /**
     * Gets the type of event this class can deal with.
     * The return value should match the result of a given
     * events Event.getTarget() function.
     * @return The type of event this class handles
     */
    String getTarget();
}
