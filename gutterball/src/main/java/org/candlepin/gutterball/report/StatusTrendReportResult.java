 ...
 */
public class StatusTrendReportResult extends HashMap<Date, Map<String, Long>> implements ReportResult {
     ...
     */
    public StatusTrendReportResult(Map<Date, Map<String, Long>> results) {
        super(results);
    }
