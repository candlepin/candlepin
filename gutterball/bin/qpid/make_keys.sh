...
COMPANY="OU=Gutterball,O=Candlepin,ST=North Carolina,C=US"
CA_NAME="CandlepinCA"
CA_PASS="password"
...
sudo mkdir -p /etc/gutterball/certs/amqp/
sudo cp keystore /etc/gutterball/certs/amqp/
sudo cp truststore /etc/gutterball/certs/amqp/
sudo chown -R tomcat:tomcat /etc/gutterball/certs/amqp/
