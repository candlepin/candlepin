...
You can use the `/bin/deployment/deploy-container` script to easily deploy these containers.
See `./bin/deployment/deploy-container --help` for all available options.
